...
export const getMemberOfTeam = (inputId) => {
    return axios.get(`/api/get-all-user-team?id=${inputId}`)
}

export const getMemberOfProject = (inputId) => {
    return axios.get(`/api/get-all-user-project?id=${inputId}`)
}